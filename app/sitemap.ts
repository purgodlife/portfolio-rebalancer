...
const ROUTES = [
  ...
  '/analysis/guides',
  '/analysis/guides/rebalancing',
  '/analysis/guides/graham-checklist',
  '/analysis/guides/tax-benefits-kr',
  '/analysis/guides/tax-benefits-us',
  '/analysis/guides/capital-gains-tax',
  '/settings/backup',
  '/settings/disclaimer',
  '/settings/about',
  '/settings/contact',
